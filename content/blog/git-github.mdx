...
- **Stage Only Certain Types of Files**
...
It's often a good idea to review which files are staged before committing. You can do this by running:

```
git diff --staged
```

This shows the differences between the last commit and the files you’ve staged, ensuring that you commit exactly what you intend to.
